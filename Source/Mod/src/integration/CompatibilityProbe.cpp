...
constexpr Pattern patterns[] = {
    {"Reach pick range legacy", "56 57 48 83 EC 28 8B 02 83 F8 01 74 0F 83 F8 03"},
    {"Reach maximum range legacy", "56 57 48 83 EC 28 48 8B 79 08 48 8D 4F 08"},
    {"GameMode getPickRange candidate", "48 83 EC 28 45 84 C0 74 25"},
    {"Actor component lookup", "48 8B 81 E8 01 00 00 C3"},
    {"HitResult actor resolver", "48 83 EC 48 48 8D 51 38 48 8D 4C 24 28"},
    {"Actor isAlive helper", "48 83 EC 28 80 B9 69 02 00 00"},
    {"AntiKnockback target", "55 41 57 41 56 56 57 53 48 81 EC D8 01 00 00"},
    {"Splash loader", "55 41 57 41 56 41 55 41 54 56 57 53 48 81 EC 88 05 00 00"},
    {"Airjump target", "55 41 57 41 56 56 57 53 48 81 EC 58 01 00 00"},
    {"Ejection target", "41 57 41 56 41 55 41 54 56 57 55 53 48 81 EC C8 00 00 00"},
    {"Chat submit", "55 41 57 41 56 56 57 53 48 81 EC D8 00 00 00"},
    {"Xray rebuild", "55 41 57 41 56 41 55 41 54 56 57 53 48 81 EC 88 00 00 00"},
    {"StateVector component hash", "DA BA 91 3C C9 0E"},
    {"MoveInput component hash", "DA BA 2E CD 8B 46"},
    {"AABBShape component hash", "DA BA F2 C9 10 1B"},
    {"Attributes component hash", "DA BA 13 06 3B FD"},
};
