...
- Type '.locate' to list up to eight other players currently loaded by the client, nearest first, with their copied 26.50 gamertag, coordinates, distance, and runtime ID. Players outside client loading range cannot be reported safely.
